...
import { Upload, Camera, ArrowLeft } from "lucide-react"; // icons
...
const CapturePage = () => {
  ...
  const [mode, setMode] = useState(null); // "upload" | "live" | null
  ...
  useEffect(() => {
    return () => stopCapture(); // stop webcam on unmount
  }, []);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[650px] bg-gradient-to-b from-gray-100 to-gray-200 pb-12 px-6">
      {/* Heading only when no mode selected */}
      {!mode && (
      ...
      {!mode && (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl w-full">
          <div
            ...
            className="cursor-pointer bg-white rounded-xl shadow-md p-6 flex flex-col items-center hover:shadow-lg hover:scale-[1.02] transition"
          >
      ...
      {mode === "upload" && (
        <div className="mt-6 bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden">
          ...
          <div className="p-4 text-center">
            <h2 className="text-xl font-semibold text-black flex items-center justify-center gap-2">
              📂 Upload an Image
            </h2>
          </div>
            ...
            {!uploadedFile ? (
              ...
              <>
                ...
                <img
                  src={uploadedFile}
                  alt="Uploaded"
                  className="w-full max-h-[400px] object-contain rounded-lg shadow-lg mb-4"
                />

                {/* Replace / Upload Another Button */}
          ...
          <div className="flex gap-4 mt-6">
            ...
            {isCapturing ? (
              ...
              <button
                ...
                className="px-5 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium shadow"
              >
                ▶ Start Capture
              </button>
            )}
